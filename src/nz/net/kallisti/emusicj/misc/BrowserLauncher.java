...
/**
 * <p>
 * Opens the default browser on the system that it's running on. Taken from:
 * {@link http://www.centerkey.com/java/browser/}.
 * </p>
 * 
 * $Id:$
 * 
	...
	public static void openURL(URL url) throws BrowserException {
		...
		try {
			if (osName.startsWith("Mac OS")) {
				 ...
				 * Class[] { String.class }); openURL.invoke(null, new Object[]
				 * { url.toString() });
				 */
				...
				if (browser == null)
					throw new BrowserException("Could not find web browser");
				Runtime.getRuntime().exec(
