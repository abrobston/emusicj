...
/**
 * <p>
 * A miscellanious collection of useful functions for working with SWT.
 * </p>
 * 
 * <p>
 * $Id$
...
public class SWTUtils {
	 ...
	 * 
	 * @param shell
	 *            the shell that this menu lives in
	 * @param base
	 *            the base menu this derives from, typically a menu bar
	 * @param text
	 ...
	 * 
	 * @param base
	 *            the menu this item goes in
	 * @param text
	 *            the text of the item
	 * @param accel
	 *            the accelleration key (null for none)
	 * @param handler
	 *            the object that handles this event
	 * @param callback
	 *            the method to call in the <code>handler</code> object. This
	 *            method is called when the item is selected.
	 * @return
	 */
	@SuppressWarnings("boxing")
	public static MenuItem createMenuItem(Menu base, String text,
			Integer accel, Object handler, String callback) {
	 ...
	 * 
	 * @param mi
	 *            the <code>MenuItem</code> to attach the listener to
	 * @param handler
	 *            the object that handles selection of this item
	 * @param callback
	 *            the method to call when the object is selected
	 */
	...
	public static ToolItem createToolItem(ToolBar tb, final Image icon,
			String tooltip, Object handler, String callback) {
	 ...
	 * @param callback
	 */
	private static void registerToolItemCallback(ToolItem item,
			final Object handler, final String callback) {
