...
/**
 * <p>
 * Handles a status line, which is basically a single label that can be put
 * somewhere. Done in a class on it's own to allow increasing its functionality
 * should that been needed.
 * </p>
 * 
 * <p>
 * $Id$
