 ...
 * @author robin
 */
public class FileInfoPanel extends Composite {
	 ...
	 * @param style the style. Currently unused.
	 */
	public FileInfoPanel(Composite parent, int style, Display display) {
		super(parent, style);
		this.display = display;
		this.setLayout(new GridLayout(2, false));
		imageArea = new Composite(this, SWT.BORDER);
...
//			artist.setVisible(false);
			...
			imageLabel.setImage(new Image(display, mdl.getCoverArt().toString()));
